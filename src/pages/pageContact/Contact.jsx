                                ...
                                <div className="row">
                                    <section className="col-lg-6 contact-form">
                                        ...
                                        <form action="emailMe" method="post" enctype="application/x-www-form-urlencoded">
                                            <input  required type="text" v-model="messageContent.name" id="name" placeholder="Votre nom" />
                                            <input  required type="mail"  v-model="messageContent.mail" id="mail" placeholder="Votre adresse email"/>
                                            <input required type="tel" v-model="messageContent.tel" id="tel" placeholder="Votre numéro de téléphone"/>
                                            <input required type="text" v-model="messageContent.sujet" id="sujet" placeholder="Sujet"/>
                                            <textarea required type="text" v-model="messageContent.message" id="message" cols="30" rows="8" placeholder="Votre message"></textarea>
