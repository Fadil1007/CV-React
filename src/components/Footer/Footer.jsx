                ...
                <div className="col-lg-3 col-md-6 footer__info">
                    <div className="container info__container">
                        ...
                        <div className="container info__logo-container">
                            <a href="https://api.github.com/users/github-john-doe" target="_blank"><img src={github} alt="github-logo"/></a>
                ...
                <div className="col-lg-3 col-md-6 footer__real">
                    <div className="container real__container">
                        ...
                        <nav className="real__nav">
                            <Link to="/Realisation" className="links"><FontAwesomeIcon icon={faChevronRight} className="links-chevron"/> Portfolio</Link>
                            <Link to="/Realisation" className="links"><FontAwesomeIcon icon={faChevronRight} className="links-chevron"/>Maquettage du site Probeat</Link>
                            <Link to="/Realisation" className="links"><FontAwesomeIcon icon={faChevronRight} className="links-chevron"/>Espace commentaire</Link>
                        </nav>
                    </div>
                </div>
